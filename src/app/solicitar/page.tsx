        ...
        {step === 2 && (
          <div className="space-y-5">
            ...
            <div>
              ...
              {geoStatus === 'error' && (
                <div className="flex items-center justify-between gap-2 mb-2 bg-amber-50 px-3 py-2 rounded-xl">
                  <span className="text-xs text-amber-600">⚠️ GPS não disponível — digite o endereço abaixo.</span>
