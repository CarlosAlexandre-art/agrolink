        ...
        {step === 2 && (
          <div className="space-y-5">
            ...
            <div>
              ...
              {geoStatus === 'error' && (
                <div className="mb-2 bg-amber-50 border border-amber-200 px-3 py-2.5 rounded-xl space-y-1.5">
                  <div className="flex items-center justify-between gap-2">
                    <span className="text-xs text-amber-700 font-medium">⚠️ GPS não capturado — use o endereço abaixo</span>
                    <button type="button" onClick={tryGPS} className="shrink-0 text-xs font-semibold text-green-700 border border-green-300 px-2 py-0.5 rounded-full hover:bg-green-50">
                      📍 Tentar novamente
                    </button>
                  </div>
                  <p className="text-xs text-amber-600">
                    Se estiver no app, vá em <strong>Configurações → AgroCore → Localização</strong> e permita o acesso.
                  </p>
                </div>
              )}
              <input
