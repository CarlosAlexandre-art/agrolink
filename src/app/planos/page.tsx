...
const PLANOS_PRODUTOR: Plano[] = [
  {
    ...
    features: [
      ...
      { txt: 'Suporte prioritário',               ok: false },
      { txt: 'Gerente de conta dedicado',      ok: false },
    ],
    priceIdMensal: null,
    priceIdAnual: null,
    cta: 'Plano atual',
  },
  {
    ...
    features: [
      ...
      { txt: 'Suporte prioritário',               ok: true },
      { txt: 'Gerente de conta dedicado',      ok: true },
      { txt: 'Equipe IA com agentes autônomos',   ok: true },
    ],
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-4 py-10 space-y-8">
        ...
        <div className="text-center space-y-4">
          ...
          <p className="text-sm text-gray-400">Cobrança mensal · Cancele quando quiser</p>
        </div>
